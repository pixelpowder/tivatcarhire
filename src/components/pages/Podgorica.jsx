...
export default function Podgorica() {
  ...
  return (
    <ContentPage title={t("podgorica.title")} subtitle={t("podgorica.subtitle")} description={t("podgorica.seoDesc")} image="/img/tivat-waterfront.webp">
      <img src="/img/tivat-waterfront.webp" alt="Podgorica" loading="lazy" />
      ...
      <img src="/img/tivat-waterfront.webp" alt="Podgorica cityscape" loading="lazy" />
